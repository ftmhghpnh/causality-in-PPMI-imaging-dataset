...
from processed_dataset2 import *
...
results_base_path = '/w/284/gzk/result/T1_severity_with_features/v14'

if not os.path.exists(results_base_path):
    os.makedirs(results_base_path)

csv_result_path = os.path.join(results_base_path, 'model_v14.csv')
save_path = os.path.join(results_base_path, 'model_v14_')
...
#     10: 1
# }
train_ds = ResnetJpegSeveritySelectedLabelsProcessedDataset(csv_path, csv_label_path, 'train')
val_ds = ResnetJpegSeveritySelectedLabelsProcessedDataset(csv_path, csv_label_path, 'val')
...
model = ResNet18Classifier(num_classes=4, freeze_weights=False)
model.to(device)
